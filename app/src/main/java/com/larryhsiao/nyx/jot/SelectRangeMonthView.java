...
/**
 * Month view drawing for select ranges.
 */
public class SelectRangeMonthView extends RangeMonthView {
    private int mRadius;

    public SelectRangeMonthView(Context context) {
        super(context);
    }
    ...
    protected void onPreviewHook() {
        ...
        mSchemePaint.setStyle(STROKE);
        mSelectedPaint.setColor(getResources().getColor(R.color.colorActive));
    }

    @Override
    protected boolean onDrawSelected(
        Canvas canvas,
        Calendar calendar,
        int x,
        int y,
        boolean hasScheme,
        boolean isSelectedPre,
        boolean isSelectedNext
    ) {
