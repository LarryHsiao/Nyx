...
import com.larryhsiao.nyx.view.tag.viewmodel.TagListViewModel
...
class TagListFragment : AuraFragment() {
    private lateinit var vm: TagListViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = TagAdapter()
        vm = ViewModelProviders.of(this).get(TagListViewModel::class.java)
